...
#define REG_SDIO0_CD_PIO_REG		(PINMUX_BASE + 0x18)
#define REG_SDIO0_CD_PIO_VALUE		(0x3)

#define REG_SDIO0_PWR_EN_PIO_REG	(PINMUX_BASE + 0x1C)
#define REG_SDIO0_PWR_EN_PIO_VALUE	(0x0)

#define REG_SDIO0_CLK_PIO_REG		(PINMUX_BASE + 0x00)
#define REG_SDIO0_CLK_PIO_VALUE 	(0x0)

#define REG_SDIO0_CMD_PIO_REG		(PINMUX_BASE + 0x04)
#define REG_SDIO0_CMD_PIO_VALUE 	(0x0)

#define REG_SDIO0_DAT0_PIO_REG		(PINMUX_BASE + 0x08)
#define REG_SDIO0_DAT0_PIO_VALUE	(0x0)

#define REG_SDIO0_DAT1_PIO_REG		(PINMUX_BASE + 0x0C)
#define REG_SDIO0_DAT1_PIO_VALUE	(0x0)

#define REG_SDIO0_DAT2_PIO_REG		(PINMUX_BASE + 0x10)
#define REG_SDIO0_DAT2_PIO_VALUE	(0x0)

#define REG_SDIO0_DAT3_PIO_REG		(PINMUX_BASE + 0x14)
...
#define REG_SDIO1_CLK_PAD_REG		(RTCIO_BASE + 0x4C)
#define REG_SDIO1_CLK_PAD_VALUE		(2)

#define REG_SDIO1_CMD_PAD_REG		(RTCIO_BASE + 0x48)
#define REG_SDIO1_CMD_PAD_VALUE		(1)

#define REG_SDIO1_DAT0_PAD_REG		(RTCIO_BASE + 0x44)
#define REG_SDIO1_DAT0_PAD_VALUE	(1)

#define REG_SDIO1_DAT1_PAD_REG		(RTCIO_BASE + 0x40)
#define REG_SDIO1_DAT1_PAD_VALUE	(1)

#define REG_SDIO1_DAT2_PAD_REG		(RTCIO_BASE + 0x3C)
#define REG_SDIO1_DAT2_PAD_VALUE	(1)

#define REG_SDIO1_DAT3_PAD_REG		(RTCIO_BASE + 0x38)
#define REG_SDIO1_DAT3_PAD_VALUE	(1)

#define REG_SDIO1_CLK_PIO_REG		(PINMUX_BASE + 0xA0)
#define REG_SDIO1_CLK_PIO_VALUE 	(0x0)

#define REG_SDIO1_CMD_PIO_REG		(PINMUX_BASE + 0x9C)
#define REG_SDIO1_CMD_PIO_VALUE 	(0x0)

#define REG_SDIO1_DAT0_PIO_REG		(PINMUX_BASE + 0x98)
#define REG_SDIO1_DAT0_PIO_VALUE	(0x0)

#define REG_SDIO1_DAT1_PIO_REG		(PINMUX_BASE + 0x94)
#define REG_SDIO1_DAT1_PIO_VALUE	(0x0)

#define REG_SDIO1_DAT2_PIO_REG		(PINMUX_BASE + 0x90)
#define REG_SDIO1_DAT2_PIO_VALUE	(0x0)

#define REG_SDIO1_DAT3_PIO_REG		(PINMUX_BASE + 0x8C)
